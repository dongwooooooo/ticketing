 ...
 */
/**
 * NOTE (Stage 4): 기본은 disabled. RedisWaitingQueue 가 활성. 호환/벤치마크용으로만 유지.
 * application.yml 에 `queue.impl=in-process` 명시할 때만 빈으로 등록.
 */
@Component
@Slf4j
@ConditionalOnProperty(name = "queue.impl", havingValue = "in-process")
